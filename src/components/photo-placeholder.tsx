 ...
 * The gradient previews the ink+brand duotone treatment real photos should
...
export function PhotoPlaceholder({
  ...
  return (
    <div
      className={cn(
        "flex flex-col items-center justify-center gap-2 rounded-2xl border border-dashed border-brand/40 bg-gradient-to-br from-primary/90 via-primary/70 to-brand/40 p-6 text-center",
        aspect,
        className
      )}
    >
